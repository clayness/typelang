...
public class Printer {
    ...
    public void print(Value v) {
        if (!Objects.equals(v.tostring(), "")) System.out.println(v.tostring());
    }

    public void print(Type t) {
        if (!Objects.equals(t.tostring(), "")) System.out.println(t.tostring());
    }
    ...
    public static class Formatter implements AST.Visitor<String, Env<Void>> {
        ...
        public String visit(AST.LetrecExp e, Env<Void> env) {
            StringBuilder result = new StringBuilder("(letrec (");
            List<String> names = e.names();
            ...
            for (int i = 0; i < num_decls; i++) {
                result.append(" (");
                result.append(names.get(i)).append(" ");
                result.append(fun_exps.get(i).accept(this, env)).append(")");
            }
            result.append(") ");
            result.append(e.body().accept(this, env)).append(" ");
            return result + ")";
